...
export function AuthLayout({
  ...
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-background text-foreground">
      {/* Left brand panel */}
      <div
        className="hidden lg:flex relative overflow-hidden border-r border-border"
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, oklch(0.72 0.19 42 / 0.25), transparent 70%)",
          }}
        />
        <div
          className="absolute -bottom-40 -right-20 h-[28rem] w-[28rem] rounded-full"
          style={{
            background: "radial-gradient(circle, oklch(0.78 0.15 175 / 0.18), transparent 70%)",
          }}
        />
        <div className="relative z-10 flex flex-col p-10 w-full">
          ...
          <div className="mt-auto space-y-6 max-w-md">
            ...
            <h2 className="text-3xl font-bold tracking-tight leading-tight">
              From customer pain to <span className="text-primary">verified product fixes.</span>
            </h2>
            <p className="text-sm text-muted-foreground">
              FixLoop AI turns every ticket into root-cause intelligence, deploy correlations, and
              revenue-recovering fixes — autonomously.
            </p>
            <div className="space-y-2.5">
              {[
                ...
                {
                  icon: BrainCircuit,
                  label: "Explainable AI investigations with confidence scores",
                },
                {
                  icon: ShieldCheck,
                  label: "Loop closure validation — measure deflection, not deploys",
                },
              ].map((f, i) => (
                <div
                  key={i}
                  className="flex items-center gap-3 rounded-md border border-border bg-card/60 backdrop-blur px-3 py-2"
                >
                  <div
                    className="h-7 w-7 rounded-md flex items-center justify-center text-primary-foreground"
...
function GoogleMark() {
  return (
    <svg width="16" height="16" viewBox="0 0 48 48" aria-hidden>
      <path
        fill="#FFC107"
        d="M43.6 20.5H42V20H24v8h11.3C33.7 32.6 29.3 36 24 36c-6.6 0-12-5.4-12-12s5.4-12 12-12c3 0 5.8 1.1 7.9 3l5.7-5.7C34.5 6.5 29.5 4.5 24 4.5 13.2 4.5 4.5 13.2 4.5 24S13.2 43.5 24 43.5c11 0 19.5-8 19.5-19.5 0-1.2-.1-2.3-.4-3.5z"
      />
      <path
        fill="#FF3D00"
        d="M6.3 14.7l6.6 4.8C14.7 16 18.9 13 24 13c3 0 5.8 1.1 7.9 3l5.7-5.7C34.5 6.5 29.5 4.5 24 4.5 16.3 4.5 9.6 8.9 6.3 14.7z"
      />
      <path
        fill="#4CAF50"
        d="M24 43.5c5.4 0 10.3-2 14-5.3l-6.5-5.3c-2 1.4-4.6 2.2-7.5 2.2-5.3 0-9.8-3.4-11.4-8.1l-6.6 5.1C9.5 39 16.2 43.5 24 43.5z"
      />
      <path
        fill="#1976D2"
        d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.3-4.3 5.6l6.5 5.3C41.8 35.4 43.5 30 43.5 24c0-1.2-.1-2.3-.4-3.5z"
      />
    </svg>
  );
}
