...
import { recentActivity, integrations } from "@/lib/mock-data";
...
function ProfilePage() {
  const { displayName, initials, email, loading } = useUser();
        ...
        <Panel className="xl:col-span-1" title="User information">
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <div className="text-xs text-muted-foreground">FixLoop Member</div>
