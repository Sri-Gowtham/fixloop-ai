...
function ForgotPasswordPage() {
  ...
  return (
    <AuthLayout
      ...
      subtitle={
        sent
          ? "We sent a secure reset link. It expires in 15 minutes."
        ...
        <div className="space-y-4">
          <div className="rounded-md border border-secondary/30 bg-secondary/5 p-4 flex items-start gap-3">
            ...
            <div className="text-sm">
              ...
              <div className="text-muted-foreground">
                Open the email and follow the link. Didn't receive it? Check spam or try again in
                60s.
              </div>
            </div>
          </div>
          <ul className="space-y-2 text-xs text-muted-foreground">
            {[
              ...
              "Single-use token, encrypted at rest",
              "Audited under SOC 2 Type II",
            ].map((t) => (
          ...
          <FxButton size="lg" variant="outline" className="w-full" onClick={() => setSent(false)}>
